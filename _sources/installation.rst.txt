...
To install MLBlocks, run this command in your terminal:

.. code-block:: console

    $ pip install mlblocks

This is the preferred method to install MLBlocks, as it will always install the most recent stable release.
